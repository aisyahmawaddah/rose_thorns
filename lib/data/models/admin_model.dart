...
class AdminModel {
  ...
  AdminModel({
    ...
    this.role = 'admin',
    this.dateCreated,
    this.permissions = const ['user_management', 'item_management', 'admin_dashboard'],
    this.isActive = true,
    this.lastLoginAt,
  });
  ...
  static AdminModel fromMap(Map<String, dynamic> data, String id) {
    return AdminModel(
      ...
      dateCreated: data['dateCreated'] != null
          ...
          : null,
      permissions: List<String>.from(data['permissions'] ?? ['user_management', 'item_management', 'admin_dashboard']),
